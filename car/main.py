...
#changing the logo
logo = pygame.image.load('car/car game/logo.jpeg')
...
def introImg(x,y):
    intro = pygame.image.load("car\car game\intro.png")
    
    screen.blit(intro,(x,y))
def instructionIMG(x,y):
    instruct = pygame.image.load("car\car game\instruction.png")
    run = True
    while run:
...
def aboutIMG(x,y):
    aboutimg = pygame.image.load("car\car game\About.png")
    run = True
    while run:
...
def introscreen():
    run = True
    pygame.mixer.music.load('car/car game/startingMusic.mp3')
...
def countdown():
    ...
    countdownBacground = pygame.image.load('car/car game/bg.png')
...
def gameloop():
      ...
      ####### music ####### 
    pygame.mixer.music.load('car\car game\BackgroundMusic.mp3')
    pygame.mixer.music.play()
    ###### sound effect for collision ######
    crash_sound = pygame.mixer.Sound('car\car game\car_crash.wav')
    ...
    #highscore part
    with open ("car\car game\highscore.txt","r") as f:
            highscore = f.read()
    ...
    def gameover():
        gameoverImg = pygame.image.load("car\car game\gameover.png")
        run = True
        while run:
    ...
    bg = pygame.image.load('car/car game/bg.png')
    
    
    # setting our player
    maincar = pygame.image.load('car\car game\car.png')
    maincarX = 350
    maincarY = 495
    maincarX_change = 0
    maincarY_change = 0
    ...
    #other cars
    car1 = pygame.image.load('car\car game\car1.jpeg')
    car1X = random.randint(178,490)
    car1Y = 100
    car1Ychange = 3    
    car2 = pygame.image.load('car\car game\car2.png')
    car2X = random.randint(178,490)
    car2Y = 100
    car2Ychange = 4

    car3 = pygame.image.load('car\car game\car3.png')
    ...
    while run:
        ...
        with open ("car\car game\highscore.txt","w") as f:
